...
\begin{figure*}[t!]
	...
	\caption{The kernel density estimates for various numerical features in relation to readmission outcome.}\label{kdeplots}
  \end{figure*}
...
The first peak in admission\_type\_id corresponds to emergency encounters which are very likely to result in readmission within 30 days.
...
The higher number of diagnoses is associated with the likelihood of readmission as seen from higher densities of orange and blue curves in the last subplot.
